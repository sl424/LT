...
EOF
	...
	ffmpeg -f x11grab -s 960x1080 -r 25 -i $DISPLAY   -f alsa -i default \
	-c:v libx264 -b:v 200k -s 960x720 test.mp4
	ffmpeg -i test.mp4 -ss 00:00:03 -t 00:00:08 -an -async 1 $path.mp4
fi
